                ...
                <div className="post-detail-content w-[75%] h-full flex-1">
                    <div className="title-content py-7 px-5 border-b w-full">
                        ...
                        <ul className='flex gap-5 mt-4'>
                            <li><Badge variant="outline">{post.data.status.toUpperCase()}</Badge></li>
                    ...
                    <div className="description-content py-7 px-5 border-b w-full">
                        ...
                        <div className="flex justify-start items-start gap-20">
                            ...
                            <div className="flex justify-center items-start gap-3">
                                ...
                                <h6 className='text-sm font-bold'>
                                    ...
                                    <br />
                                    <span className='text-xs font-normal'>I am looking for producers/sellers <br /> with the lowest price.</span>
                                </h6>
                            </div>
                        </div>
                    </div>
                    <div className="commodity-content py-7 px-5 border-b w-full">
                        <h6 className="text-sm flex gap-2">
                            ...
                            <span className="font-bold">
                                ( {post.data.commodity.subCommodity} )
                            </span>
                        </h6>
                    </div>
                ...
                <div className="post-sidebar border-l py-7 px-5 w-[25%]">
                    <div className="flex gap-10 flex-col">
                        <div className="flex gap-2 flex-col">
                            ...
                            <Button variant={'outline'} className="w-full font-semibold rounded-full text-md"><Heart className='mr-2' size={17} /> Save Post</Button>
                        </div>
                        <div className="client-details">
                            ...
                            <h3>{post.data.userInfo.firstname} {post.data.userInfo.lastname}</h3>
