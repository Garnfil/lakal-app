  ...
  return (
    <div className='flex items-center h-16 border p-4 rounded-md'>
      <nav className='flex items-center space-x-4 lg:space-x-6 '>
        <Link className="text-sm text-black font-medium" href="/">Market Place</Link>
        <Link className="text-sm text-black font-medium" href="">My Posts</Link>
        <Link className="text-sm text-black font-medium" href="">Reports</Link>
        <Link className="text-sm text-black font-medium" href="">Contracts</Link>
      </nav>
      <div className="ml-auto flex items-center space-x-3">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            <DropdownMenuLabel>
              <h5>James Garnfil</h5>
              <h6 className='font-light text-[12px]'>jamesgarnfil15@gmail.com</h6>
            </DropdownMenuLabel>
            <DropdownMenuSeparator />
