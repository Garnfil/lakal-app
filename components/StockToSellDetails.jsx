...
export default function StockToSellDetails({ post }) {
    return (
        <div className="flex justify-between w-full h-full">
            <div className="post-detail-content w-[75%] h-full flex-1">
                <div className="title-content py-7 px-5 border-b w-full">
                    ...
                    <ul className="flex gap-5 mt-4">
                        ...
                        <li className="flex gap-1 items-center">
                            ...
                            {post.data.locationOfStock.municipality}, {post.data.locationOfStock?.province}
                        </li>
                    </ul>
                </div>
                    ...
                    <div className="flex justify-start items-start gap-20">
                        <div className="flex justify-center items-start gap-3">
                            ...
                            <h6 className="text-sm font-bold">
                                ₱ {numberWithCommas(post.data.floorPrice.toFixed(2))}
                                <br />
                                {post.data.partialOffer && <span className="text-green-800 text-xs">Partial Fulfillment Accepted</span>}
                            </h6>
                        </div>
                        <div className="flex justify-center items-start gap-3">
                ...
                <div className="supplier-qualification-content py-7 px-5 border-b w-full">
                    <h3 className="text-lg font-semibold mb-2">Packing Type</h3>
                    <p className="text-sm">{post.data.packingType}</p>
                </div>
            </div>
